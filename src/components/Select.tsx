...
const Select: FC<SelecType> = ({ extraClass, URL, customList, setValue, value, setLoading }) => {
    ...
    return (
        <div>
            <select value={value} onChange={handleSelectChange} name="category" className={`w-60 bg-transparent border-b-2 border-[#c7c0b1] text-[#c7c0b1] px-2 py-3 outline-none tracking-[3px] focus:border-[#d4a017] transition-all duration-300 ${extraClass}`} >
